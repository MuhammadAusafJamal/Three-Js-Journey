...
| [Day / Night Cycle](./Day-Night-Cycle) | A 3D scene where the sun rises and sets in a loop over a cottage in a forest — the sky shifts through day, sunset, and night while shadows sweep across the ground. A moon lights the night side, fireflies glow into life after dark, and a lil-gui panel lets you tweak everything live. | https://three-js-journey-day-night--with-particles.vercel.app/ |
