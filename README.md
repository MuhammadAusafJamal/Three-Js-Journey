...
| [Animated Character](./Animated-Character) | An interactive scene with a robot you can walk and jump around a grassy field (WASD + Space). Click the robot to cycle its animations, or click the ground to make it hurl a physics ball at a pyramid of blocks — knock them all down to win. Built with Rapier physics and a ray-caster. | https://three-js-journey-animated-character.vercel.app/ |
| [Basic Minecraft Clone](./Basic-Minecraft-Clone) | A first-person voxel sandbox — spawn into an endless, procedurally generated world of grass, dirt, stone, sand, water and trees (streamed in chunks as you roam), then walk, jump or fly around (WASD + Space) to break and place blocks. Has a day/night cycle with an orbiting sun and moon, advanced blocks (glass, water, exploding TNT), and runs on Rapier physics. | https://three-js-journey-basic-minecraft-clone.vercel.app/ |
